				...
				<div class="col">
					<div class="container-fluid">
						<div class="d-flex align-items-center">
							<h1 class="display-5 px-1">Problem M-003</h1>
						</div>
					</div>
					<div class="container-fluid">
						<div class="d-flex align-items-center">
							...
							<div class="carousel-item active">
								<div class="container-fluid">
									<div class="d-flex justify-content-center align-items-center">
										<div class="p-2">
											<img src="problem/perkalian 3.jpg" width="1100" height="500" style="margin:auto">
										</div>
									</div>
								</div>
							</div>
		...
		<div class="container py-5">
			<div class="row justify-content-center text-center">
				...
				<div id='block-12' class="col" style='padding: 10px;'>
					...
					<input type='radio' name='option' value='9' id='option-12' style='transform: scale(1.6); margin-right: 10px; vertical-align: middle; margin-top: -2px;' />
					9</label>

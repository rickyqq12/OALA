...
<html>
	...
	<body style="background-image:url(imgs/prob.jpg); background-size:cover;">
		<!-- NAVBAR -->
				...
				<div class="col">
					<div class="container-fluid">
						<div class="d-flex align-items-center">
							<h1 class="display-5 px-1">Penjumlahan</h1>
						</div>
					</div>
					<div class="container-fluid">
						<div class="d-flex align-items-center">
							...
							<div class="carousel-item active">
								<div class="container-fluid">
									<div class="d-flex justify-content-center align-items-center">
										<div class="p-2">
											<img src="material/penjumlahan.png" width="1100" height="500" style="margin:auto">
										</div>
									</div>
								</div>
							</div>

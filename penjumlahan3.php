...
<html>
	...
	<body style="background-image:url(imgs/quest_3.jpg); background-size:cover;">
		<!-- NAVBAR -->
				...
				<div class="col">
					<div class="container-fluid">
						<div class="d-flex align-items-center">
							<h1 class="display-5 px-1">Problem A-003</h1>
						</div>
					</div>
					<div class="container-fluid">
						<div class="d-flex align-items-center">
							...
							<div class="carousel-item active">
								<div class="container-fluid">
									<div class="d-flex justify-content-center align-items-center">
										<div class="p-2">
											<img src="problem/penjumlahan 3.jpg" width="1100" height="500" style="margin:auto">
										</div>
									</div>
								</div>
							</div>
		...
		<div class="container py-5">
			<div class="row justify-content-center text-center">
				...
				<div id='block-11' class="col" style='padding: 10px;'>
					...
					<input type='radio' name='option' value='8' id='option-11' style='transform: scale(1.6); margin-right: 10px; vertical-align: middle; margin-top: -2px;' />
					8</label>
				...
				<div id='block-12' class="col" style='padding: 10px;'>
					...
					<input type='radio' name='option' value='10' id='option-12' style='transform: scale(1.6); margin-right: 10px; vertical-align: middle; margin-top: -2px;' />
					10</label>
				...
				<div id='block-13' class="col" style='padding: 10px;'>
					...
					<input type='radio' name='option' value='7' id='option-13' style='transform: scale(1.6); margin-right: 10px; vertical-align: middle; margin-top: -2px;' />
					7</label>
				...
				<div id='block-14' class="col" style='padding: 10px;'>
					...
					<input type='radio' name='option' value='5' id='option-14' style='transform: scale(1.6); margin-right: 10px; vertical-align: middle; margin-top: -2px;' />
					5</label>
				...
				<script>
					...
					function displayAnswer1() {
						document.getElementById('block-11').style.border = '1px solid red'
						...
						document.getElementById('block-13').style.border = '5px solid limegreen'
